...
> **Archivos base**
> 
> Copia los siguientes archivos en tu entorno de desarrollo local, en la misma carpeta. Los encontrarás dentro de la carpeta `Recursos`:
> 
> - **index.html**
> - **styles.css**
> - **script.js**
...
> Utiliza la API del DOM para realizar las siguientes consultas y obtener información de la página:
...
>
> Revisa la documentación recomendada:
...
> ### Ejercicio 2: Modificación añadiendo una película
> Añade un nuevo elemento (película) al final de la lista existente usando el DOM. La nueva película debe tener la misma estructura que las demás.
>
> Revisa la documentación recomendada:
...
> Elimina el primer elemento que representa una película de la lista mediante la manipulación del DOM.
>
> Revisa la documentación recomendada:
